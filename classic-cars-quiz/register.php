...
<html lang="en">
	...
	<div class = "grid">
        ...
        <!-- Background Image -->
        <body background = "web-assets/images/e30.jpg">
			<div class = "register-content">
				<article>
                    <h2>Sign Up</h2>   

                    <!-- Registration Form -->
                    <form action="action_page.php" onsubmit="return validation()" method="post">
                        <div class="register-form">
                            ...
                            <input type="text" placeholder="Age" id="ageInput" required>
                            ...
                            <select id="nationalityInput" required>
                            ...
                            <!-- Register Button -->
                            <button type="button" class="regiser-btn" onclick="register()">Register</button>
                        </div>
                    </form>

                    <!-- Success/Failiure of Registration Output -->
